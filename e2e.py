...
# SSIM (Structural Similarity Index) calculation: measures the similarity between output alpha and groundtruth alpha
ssim_ori = ssim(alpha, image_alpha, data_range=image_alpha.max() - image_alpha.min())
print(f"The SSIM of Original_bay is: {ssim_ori} (dB)")
ssim_unshp = ssim(unsharped_alpha, image_alpha, data_range=image_alpha.max() - image_alpha.min())
print(f"The SSIM of Unsharped_bay is: {ssim_unshp} (dB)")
ssim_lap = ssim(lap_alpha, image_alpha, data_range=image_alpha.max() - image_alpha.min())
